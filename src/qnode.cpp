...
void QNode::amcl_pose_callback(const geometry_msgs::PoseWithCovarianceStamped &msg){
    ...
    emit position(msg.pose.pose.position.x,msg.pose.pose.position.y,msg.pose.pose.position.z);
}
void QNode::setGoal(double x,double y,double z){
    geometry_msgs::PoseStamped goal;
    goal.header.frame_id=mapFrameId;
