#include "../include/class1_ros_qt_demo/qrviz.hpp"
#include <QDebug>
#include <QException>
qrviz::qrviz(QVBoxLayout* layout)
{
    ...
    //初始化render_panel 实现放大缩小等操作,注意顺序
    ...
    manager_->removeAllDisplays();//移除所有图层
...
//    Global_Planner_->subProp("Topic")->setValue(planner_topic);//会出现闪退情况
